package cn.kutils.media.jiecaovideoplayer;
...
public class JCMediaManager implements TextureView.SurfaceTextureListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private static cn.kutils.media.jiecaovideoplayer.JCMediaManager JCMediaManager;
    ...
    public static cn.kutils.media.jiecaovideoplayer.JCMediaManager instance() {
            ...
            switch (msg.what) {
                case HANDLER_PREPARE:
                    try {
                        ...
                        mediaPlayer.setOnPreparedListener(cn.kutils.media.jiecaovideoplayer.JCMediaManager.this);
                        mediaPlayer.setOnCompletionListener(cn.kutils.media.jiecaovideoplayer.JCMediaManager.this);
                        mediaPlayer.setOnBufferingUpdateListener(cn.kutils.media.jiecaovideoplayer.JCMediaManager.this);
                        mediaPlayer.setScreenOnWhilePlaying(true);
                        mediaPlayer.setOnSeekCompleteListener(cn.kutils.media.jiecaovideoplayer.JCMediaManager.this);
                        mediaPlayer.setOnErrorListener(cn.kutils.media.jiecaovideoplayer.JCMediaManager.this);
                        mediaPlayer.setOnInfoListener(cn.kutils.media.jiecaovideoplayer.JCMediaManager.this);
                        mediaPlayer.setOnVideoSizeChangedListener(cn.kutils.media.jiecaovideoplayer.JCMediaManager.this);
