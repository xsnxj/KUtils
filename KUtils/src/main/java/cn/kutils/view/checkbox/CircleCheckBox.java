package cn.kutils.view.checkbox;
...
public class CircleCheckBox extends MaterialCheckBox {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBorderWidth =
                    a.getDimensionPixelOffset(R.styleable.CircleCheckBox_border_width_checkbox, UNSET_FLAG);
            mBorderColor =
                    a.getColor(R.styleable.CircleCheckBox_border_color_checkbox, Color.parseColor("#4AC65A"));
